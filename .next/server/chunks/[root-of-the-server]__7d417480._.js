module.exports = [
"[project]/ift-401/.next-internal/server/app/api/admin/stocks/[symbol]/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/ift-401/app/api/admin/stocks/[symbol]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(req, { params }) {
    try {
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$ift$2d$401$2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from('ticker').update({
            company_name: name,
...
async function DELETE(req, { params }) {
    try {
        const symbol = params.symbol.toUpperCase();
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$ift$2d$401$2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from('ticker').delete().eq('symbol', symbol);
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7d417480._.js.map