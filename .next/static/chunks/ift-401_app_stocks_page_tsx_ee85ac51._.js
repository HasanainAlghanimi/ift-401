...
"[project]/ift-401/app/stocks/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const cap = (n)=>n >= 1e12 ? "".concat((n / 1e12).toFixed(2), "T") : n >= 1e9 ? "".concat((n / 1e9).toFixed(2), "B") : n >= 1e6 ? "".concat((n / 1e6).toFixed(2), "M") : usd(n);
const pctf = (n)=>"".concat(n > 0 ? '+' : '').concat(n.toFixed(2), "%");
function cmp(a, b) {
...
function StocksPage() {
    _s();
    const [query, setQuery] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$ift$2d$401$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const list = (0, __TURBOPACK__imported__module__$5b$project$5d2f$ift$2d$401$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "StocksPage.useMemo[list]": ()=>{
            ...
            }["StocksPage.useMemo[list].filtered"]);
            const dir = sortDir === 'asc' ? 1 : -1;
            return [
                ...filtered
            ].sort({
                "StocksPage.useMemo[list]": (a, b)=>cmp(a[sortKey], b[sortKey]) * dir
            }["StocksPage.useMemo[list]"]);
        }
    }["StocksPage.useMemo[list]"], [
        query,
...
//# sourceMappingURL=ift-401_app_stocks_page_tsx_ee85ac51._.js.map