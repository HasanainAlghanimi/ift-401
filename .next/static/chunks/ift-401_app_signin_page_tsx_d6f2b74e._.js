...
function SignInPage() {
    ...
    const onSubmit = async (e)=>{
        ...
        try {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$ift$2d$401$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
                email: form.email,
            ...
            const { data: userRow, error: userRowError } = await __TURBOPACK__imported__module__$5b$project$5d2f$ift$2d$401$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('users').select('user_type').eq('email', form.email).single();
            let role = 'user';
            if (!userRowError && (userRow === null || userRow === void 0 ? void 0 : userRow.user_type) === 'Admin') {
                role = 'admin';
            }
